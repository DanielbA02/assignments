...
class player {
    ...
    gotHit(){
        if (this.hasStar === true){
            console.log("Your star protected you from the hit! However you lose your star..")
            this.hasStar = false
        }
        else if (this.status === "Powered Up"){
            console.log("You went from powered up to big")
            this.status = "Big"
        }
        else if (this.status === "Big"){
            console.log("You went from big to small")
            this.status = "Small"
        }
    ...
    gotPowerup(){
        if (this.status === "Powered Up"){
            ...
            console.log("You went from big to powered up!")
            this.status = "Powered Up"
        } else if (this.status === "Small"){
            console.log("You went from small to big!")
            this.status = "Big"
        }
    }
    addCoin(){
