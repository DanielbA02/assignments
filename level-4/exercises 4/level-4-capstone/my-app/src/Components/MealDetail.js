    ...
    <>
      ...
      <div className="meal-container">
        ...
        <div className="details-container">
          <h2 className="detail-area">
            <b>Meal Origin:</b> {mealDetail?.strArea}
          </h2>
          <h2 className="detail-ingredients">
            <b>Ingredients: </b>
            {mealDetail?.strIngredient?.map((ingredient) => {
              return (
                <span
                  key={mealDetail?.idMealstrMeal + ingredient.ingredientName}
                >
          ...
          <h2 className="detail-instructions ">
            <b>Instructions:</b> {mealDetail?.strInstructions}
          </h2>
